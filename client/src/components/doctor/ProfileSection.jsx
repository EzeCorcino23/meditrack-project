  ...
  return (
    <div>
      ...
      <div style={{ display:"grid", gridTemplateColumns:"1fr 1fr", gap:"14px 16px", marginBottom:20 }}>
        {[
          { label:"Nombre completo", key:"name",      placeholder:"Dr. Carlos Méndez"   },
          { label:"Especialidad",    key:"specialty",  placeholder:"Medicina General"    },
          { label:"Correo",          key:"email",      placeholder:"doctor@clinica.com", type:"email" },
